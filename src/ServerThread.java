            ...
            try {
                ...
                if(line.startsWith("u")) {
                    ...
                    if(!rightToAccess(user,service))
                    	...
                    	System.out.println("m " + c.cMessage("Hello World of Encryption using 3DES ", 0));
                    	String crypt = c.encryptMessage("Hello World of Encryption using 3DES ");
                    	System.out.println("aici! " + crypt);
                    	String decrypt = c.decryptMessage(c.encryptMessage("Am mere! Tu?"));
                    	System.out.println("aici! " + decrypt);
